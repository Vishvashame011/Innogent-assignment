package multithreading_assignment5.readWriteLock;
...
public class ReadWriteLock {
    ...
    public static void main(String[] args) {
        ...
        Thread writer1 = new Thread(ReadWriteLock::writeData, "Writer-1");
        Thread writer2 = new Thread(ReadWriteLock::writeData, "Writer-2");
